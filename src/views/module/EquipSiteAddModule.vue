...
<script>
  ...
  import { updateEquipmentSiteRel,insertEquipmentSiteRel,getBaseIdAndBaseName,getLotIdAndName,getEquipmentIdAndNameList,getEquipmentIdAndNameListNotIn} from '@/api/userApi'
  export default {
    data() {
      return {
        valss:'',
    ...
    methods: {
      ...
      add(){
        ...
        getEquipmentIdAndNameListNotIn().then((res=>{
